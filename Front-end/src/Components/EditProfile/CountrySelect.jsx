      ...
      useEffect(()=>{
        ...
        return(
          <div style={{display: "flex"}}>
             <input value={country} onChange={handlerChange} type="text" name="country" id="" />
              { country.length > 0 && 
            ...
            <div className={s.countryList}>
              ...
              >
                ...
                <img id={c.label} style={{height:"fit-content"}} src={`https://flagcdn.com/w40/${c.code.toLowerCase()}.png`} alt="" />
              </div>
              )
              })}
            </div>
